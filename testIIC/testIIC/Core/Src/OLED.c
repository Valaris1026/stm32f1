 ...
 * @retval 无
 */
bool I2C_WriteByte( uint8_t addr,
                    uint8_t data )
{
 ...
 * @retval 无
 */
void OLED_SetPos( unsigned char x,
                  unsigned char y ) /*设置起始点坐标 */
{
    WriteCmd( 0xb0 + y );
...
// * @retval 无
// */
//void OLED_ShowCN( unsigned char x,
//                  unsigned char y,
//                  unsigned char N )
//{
//    unsigned char wm = 0;
